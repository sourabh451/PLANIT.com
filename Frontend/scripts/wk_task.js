...
form1.addEventListener("submit", (e) => {
  ...
  fetch("https://glorious-bull-girdle.cyclic.app/tasks/add", {
    method: "POST",
    headers: {
...
function updateUser() {
  ...
  for (let btn of cardBtn) {
    btn.addEventListener("click", function (e) {
      ...
      fetch(`https://glorious-bull-girdle.cyclic.app/tasks/${id}`, {
        headers: {
          Authorization: localStorage.getItem("token"),
        },
      })
...
function updatefn() {
  ...
  fetch(`https://glorious-bull-girdle.cyclic.app/tasks/update/${idt}`, {
    method: "PATCH",
    headers: {
      "content-type": "application/json",
      Authorization: localStorage.getItem("token"),
...
function deleteUser() {
  ...
  for (let btn of cardBtnn) {
    btn.addEventListener("click", function (e) {
      e.preventDefault();
      let id = e.target.dataset.id;
      fetch(`https://glorious-bull-girdle.cyclic.app/tasks/delete/${id}`, {
        method: "delete",
        headers: {
          Authorization: localStorage.getItem("token"),
        },
...
formA.addEventListener("submit", (e) => {
  ...
  fetch(`https://glorious-bull-girdle.cyclic.app/tasks?board=${fboard}`, {
    headers: {
      Authorization: localStorage.getItem("token"),
    },
  })
...
formB.addEventListener("submit", (e) => {
  ...
  fetch(
    `https://glorious-bull-girdle.cyclic.app/tasks?person_allocated=${fname}`,
    {
      headers: {
        Authorization: localStorage.getItem("token"),
      },
...
filterByStatus.addEventListener("change", () => {
  ...
  if (filterByStatusV == "") {
    ...
    fetch(
      `https://glorious-bull-girdle.cyclic.app/tasks?status=${filterByStatusV}`,
      {
        headers: {
          Authorization: localStorage.getItem("token"),
        },
...
formC.addEventListener("submit", (e) => {
  ...
  fetch(
    `https://glorious-bull-girdle.cyclic.app/tasks?search=${fsearch}&fields=person_allocated,board,task,p_email`,
    {
      headers: {
        Authorization: localStorage.getItem("token"),
      },
...
sortByStartdate.addEventListener("change", () => {
  ...
  if (sortByStartdateV == "") {
    ...
    fetch(
      `https://glorious-bull-girdle.cyclic.app/tasks?sortbyasc=start_date`,
      {
        headers: {
          Authorization: localStorage.getItem("token"),
        },
    ...
    fetch(
      `https://glorious-bull-girdle.cyclic.app/tasks?sortbydesc=start_date`,
      {
        headers: {
          Authorization: localStorage.getItem("token"),
        },
